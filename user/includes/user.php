...
class User{
    ...
    public function reg_user($firstname, $lastname, $uname, $uemail, $upass, $phone){
        ...
        if ($count_row == 0){
            $sql1="INSERT INTO users SET uname='$uname', upass='$upass', fullname= '$firstname  $lastname', uemail='$uemail', phone='$phone'";
